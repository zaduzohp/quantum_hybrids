# VENDORED from qml_benchmarks/data/hidden_manifold.py (commit 95e5a07e8e9e75ba7e24e67fb32b030112a1309a, 2025-08-22)
# Upstream: https://github.com/XanaduAI/qml-benchmarks (Apache-2.0)
# Changes vs upstream: none — verbatim copy, this header is the only addition.
#
# Why copied: qml_benchmarks/data/__init__.py imports ising.py, whose header does
# "import jax" and "from numpyro.infer import MCMC". Importing a submodule executes
# the parent package's __init__.py, so these two generators are unreachable without
# jax/numpyro. This copy imports numpy and scikit-learn only.
# Equivalence with upstream verified bit-for-bit — see tests/test_vendored_generators.py.
