# VENDORED from qml_benchmarks/data/hyperplanes.py:1 (commit 95e5a07e8e9e75ba7e24e67fb32b030112a1309a, 2026-08-18)
...
# the parent package's __init__.py, so this generator is unreachable without
# jax/numpyro. This copy imports numpy and scikit-learn only.
# Behaviour pinned by tests/test_vendored_hyperplanes.py.
